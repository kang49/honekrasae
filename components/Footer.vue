    ...
    <footer class="bg-black min-w-full min-h-max grid grid-cols-3 gap-1.5">
        <div class="my-5">
            <div class="text-white ml-2 text-[0.6rem] space-y-1">
                ...
                <h4 class="hover:underline"><i class="fab fa-line mr-1"></i>@honkasaeOfficial</h4>
                <h4 class="hover:underline"><i class="fas fa-envelope mr-1"></i>contact@honkasae.com</h4>
            </div>
        </div> <!--col1-->
        <div class="flex justify-center items-center min-h-full">
            <center class="text-white text-[0.6rem] space-y-1">
                <h4><i class="far fa-copyright mr-1"></i><b>Honkasae</b> Copyright 2023</h4>
